...
import Grid from "@mui/material/Grid"; // MUI v5 Grid (com item/container)
...
// Landing refinada (foco mobile-first) – MUI v5
// Melhorias: tipografia responsiva, espaçamentos maiores no mobile, CTA persistente, hero mais "clean",
// cartões com contraste suave, chips de prova social, botões 100% largura no mobile, checklist visual.
    ...
    <Box sx={{ minHeight: "100vh", bgcolor: "#fff" }}>
      ...
      <Box
        ...
        sx={{
          ...
          inset: 0,
          background: {
            xs: "radial-gradient(60% 40% at 20% 10%, #ffe4e6 0%, rgba(255,228,230,0) 60%), radial-gradient(50% 35% at 90% 0%, #fce7f3 0%, rgba(252,231,243,0) 60%)",
            md: "radial-gradient(40% 35% at 15% 10%, #ffe4e6 0%, rgba(255,228,230,0) 60%), radial-gradient(35% 35% at 85% 5%, #fce7f3 0%, rgba(252,231,243,0) 60%)",
          },
          pointerEvents: "none",
          zIndex: 0,
        }}
